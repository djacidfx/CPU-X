...
public class AdNetworkHelper {
    ...
    public static void initConfig() {
        ...
        AdConfig.retry_from_start_max = AppConfig.ads.retry_from_start_max;
        AdConfig.enable_gdpr = AppConfig.ads.ad_enable_gdpr;

        AdConfig.ad_replace_unsupported_open_app_with_interstitial_on_splash = AppConfig.ads.ad_replace_unsupported_open_app_with_interstitial_on_splash;
